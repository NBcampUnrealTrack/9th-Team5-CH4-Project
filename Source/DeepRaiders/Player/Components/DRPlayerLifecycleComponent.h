...
class DEEPRAIDERS_API UDRPlayerLifecycleComponent
...
private:
    ...
    bool TryFindRagdollRespawnTransform(
...
protected:
    ...
    float RespawnGroundTraceDistance =
        2000.f;
    ...
    UPROPERTY(
        EditDefaultsOnly,
        BlueprintReadOnly,
        Category = "Lifecycle|Fall Damage",
    ...
    UPROPERTY(
        EditDefaultsOnly,
        BlueprintReadOnly,
        Category = "Lifecycle|Fall|Camera Shake")
